...
<section class="checkout">
   ...
   <option value="bank transfer">Bank Transfer</option>
         ...
         <input type="text" name="bank_account_number" placeholder="Enter your bank account number">
         </div>
         ...
         <div class="inputBox">
            <span>address brgy/street :</span>
            <input type="text" name="street" required placeholder="ex. street name">
         </div>
         <div class="inputBox">
            <span>city :</span>
            <input type="text" name="city" required placeholder="ex. Cavite">
         </div>
         <div class="inputBox">
            <span>country :</span>
            <input type="text" name="country" required placeholder="ex. Philippines">
         </div>
         <div class="inputBox">
            <span>pin code :</span>
